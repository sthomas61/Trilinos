...
Language make_language() {
  ...
  prods.resize(NPRODS);
  toks.resize(NTOKS);
  prods[PROD_DOC]("doc") >> "prolog", "toplevel", "epilog";
  prods[PROD_PROLOG]("prolog") >> "NEWLINE", "directive?", "DOC_START", "NEWLINE";
  prods[PROD_NO_DIRECT]("directive?");
  prods[PROD_ONE_DIRECT]("directive?") >> "directive";
  prods[PROD_DIRECT]("directive") >> "DIRECTIVE", "NEWLINE";
  prods[PROD_EPILOG]("epilog") >> "DOC_END", "NEWLINE";
  prods[PROD_TOP_BMAP]("toplevel") >> "block_map_items";
  prods[PROD_TOP_BSEQ]("toplevel") >> "block_sequence_items";
  ...
  prods[PROD_BSEQ_NEXT_ITEM]("block_sequence_items") >> "block_sequence_items", "block_sequence_item";
  prods[PROD_BSEQ_SCALAR]("block_sequence_item") >> "comments", "BLOCK_SEQ", "scalar", "S?", "NEWLINE";
  prods[PROD_BMAP_ITEM]("block_map_item") >> "comments", "scalar", "S?", ":", "S?", "block_map_value";
  prods[PROD_BMAP_SCALAR]("block_map_value") >> "scalar", "S?", "NEWLINE";
  prods[PROD_BMAP_BLOCK]("block_map_value") >> "NEWLINE", "block_collective";
  prods[PROD_BMAP_FLOW]("block_map_value") >> "flow_collective", "NEWLINE";
  ...
  prods[PROD_FSEQ_FIRST_ITEM]("flow_sequence_items") >> "flow_sequence_item";
  prods[PROD_FSEQ_NEXT_ITEM]("flow_sequence_items") >> "flow_sequence_items", "FLOW_SEP", "S?", "flow_sequence_item";
  prods[PROD_FSEQ_SCALAR]("flow_sequence_item") >> "scalar", "S?";
  prods[PROD_FSEQ_FLOW]("flow_sequence_item") >> "flow_collective", "S?";
  prods[PROD_FMAP_FIRST_ITEM]("flow_map_items") >> "flow_map_item";
  prods[PROD_FMAP_NEXT_ITEM]("flow_map_items") >> "flow_map_items", "FLOW_SEP", "S?", "flow_map_item";
  ...
  prods[PROD_COMMENTS]("comments") >> "comments", "COMMENT", "NEWLINE";
